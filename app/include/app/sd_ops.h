...
extern "C"
{
    ...
    /* Synchronous format (no worker); unmounts, mkfs, and remounts. */
    int sd_format_sync(void);

    /* Create/overwrite file with deterministic pseudo-random contents (xorshift32)
     * of the given size, seeded with 'seed'. */
